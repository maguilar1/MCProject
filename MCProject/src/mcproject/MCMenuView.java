...
public class MCMenuView extends GContainer {
	...
	public MCMenuView() {
		...
		GSprite none_imgs = new GSprite(ImageCache.getImage("buttons/none1.png"));
		GSprite hover_imgs = new GSprite(ImageCache.getImage("buttons/hover1.png"));
		GSprite pressed_imgs = new GSprite(ImageCache.getImage("buttons/pressed1.png"));
		
		GSprite none_imge = new GSprite(ImageCache.getImage("buttons/none1.png"));
		GSprite hover_imge = new GSprite(ImageCache.getImage("buttons/hover1.png"));
		GSprite pressed_imge = new GSprite(ImageCache.getImage("buttons/pressed1.png"));
		//creating buttoms
		...
		ButtonListener play_btnlist = new ButtonListener() {
			...
			MusicConductor.addListener(play_btnlist);
		}
	}
